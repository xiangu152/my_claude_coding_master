...
# Performance
> 原始文档来源：https://pydantic.dev/docs/validation/latest/concepts/performance/
...
Many performance improvements are currently in the works for pydantic-core, see this discussion. Once these changes are merged, we should be at the point where model_validate_json() is always faster than model_validate(json.loads(...)).
