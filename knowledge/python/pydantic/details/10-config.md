...
# Config
> 原始文档来源：https://pydantic.dev/docs/validation/latest/concepts/config/
...
Type adapters (using the TypeAdapter class) support configuration, by providing the config argument.
...
The @validate_call also supports setting custom configuration. See the dedicated section for more details.
