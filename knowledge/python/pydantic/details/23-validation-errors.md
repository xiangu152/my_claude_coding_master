...
# Validation Errors
> 原始文档来源：https://pydantic.dev/docs/validation/latest/errors/validation_errors/
...
This error is raised when a default factory taking validated data can’t be called, because validation failed on previous fields:
