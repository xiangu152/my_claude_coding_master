...
> 原始文档来源：https://docs.docker.com/reference/compose-file/services/
...
required
Requires:
Docker Compose 2.24.0 and later
...
label_file
Requires:
Docker Compose 2.32.2 and later
...
mac_address
Requires:
Docker Compose 2.23.2 and later
...
pre_start
Requires:
Docker Compose 5.3.0 and later
...
uts
Requires:
Docker Compose 2.15.1 and later
