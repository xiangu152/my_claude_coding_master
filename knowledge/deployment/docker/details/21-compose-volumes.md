...
> 原始文档来源：https://docs.docker.com/reference/compose-file/volumes/
...
The type, o, and device keys are passed through to the local driver. For a one-off host-path mount on a single service, see bind mounts.
