...
> 原始文档来源：https://code.claude.com/docs/en/agent-sdk/slash-commands
...
Wrap the loop in a try/catch in TypeScript or try/except in Python if your command might hit the limit, as shown in Single Message Input, or set maxTurns high enough for the work to complete. In Python, catch Exception: the SDK surfaces error results as a plain Exception.
